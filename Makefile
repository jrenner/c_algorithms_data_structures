...
all: objects 
	$(CC) $(CCFLAGS) main.c $(OBJDIR)/sort_utils.o $(OBJDIR)/selection_sort.o $(OBJDIR)/merge_sort.o $(OBJDIR)/insertion_sort.o $(OBJDIR)/bubble_sort.o -o main
...
clean:
	rm main $(OBJDIR)/merge_sort.o $(OBJDIR)/sort_utils.o $(OBJDIR)/selection_sort.o $(OBJDIR)/insertion_sort.o $(OBJDIR)/bubble_sort.o